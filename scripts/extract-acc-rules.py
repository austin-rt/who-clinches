#!/usr/bin/env python3
"""
Extract ACC Tiebreaker Rules from PDF

Fetches the ACC tiebreaker rules PDF from theacc.com, extracts text content,
cleans PDF artifacts (page numbers, form feeds, excessive whitespace), and saves
it to docs/tiebreaker-rules/acc-tiebreaker-rules.txt for AI agent reference.

Usage:
    python scripts/extract-acc-rules.py
...
ACC_TIEBREAKER_URL = "https://s3.amazonaws.com/sidearm.sites/acc.sidearmsports.com/documents/2023/5/17/ACC_FOOTBALL_TIEBREAKER_POLICY.pdf"
ACC_ALTERNATIVE_URL = "https://theacc.com/documents/2023/5/17/ACC_FOOTBALL_TIEBREAKER_POLICY.pdf"
TEMP_DIR = Path(__file__).parent.parent / "temp"
OUTPUT_DIR = Path(__file__).parent.parent / "docs" / "tiebreaker-rules"
TEMP_PDF = TEMP_DIR / "acc-rules.pdf"
OUTPUT_TXT = OUTPUT_DIR / "acc-tiebreaker-rules.txt"
...
def main():
    ...
    print("Who Clinches - ACC Tiebreaker Rules Extraction Script")
    print("=" * 50)
    ...
    pdf_urls = [ACC_TIEBREAKER_URL, ACC_ALTERNATIVE_URL]
