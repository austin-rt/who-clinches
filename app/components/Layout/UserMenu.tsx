...
const UserMenu = ({ isNonProd }: { isNonProd: boolean }) => {
  ...
  if (email) {
    return (
      <div className="relative" ref={menuRef}>
        ...
        {open && (
          <div
            className="absolute right-0 top-full z-50 mt-2 w-56 rounded-lg border border-base-300 bg-base-100 py-2 shadow-lg"
            data-testid="user-menu-dropdown"
          >
            <p className="text-base-content/50 truncate px-3 py-1 text-xs" data-testid="user-email">
              {email}
            </p>
  ...
  return (
    <div className="relative" ref={menuRef}>
      ...
      {open && (
        <div
          className="absolute right-0 top-full z-50 mt-2 w-64 rounded-lg border border-base-300 bg-base-100 p-3 shadow-lg"
          data-testid="sign-in-popover"
        >
          {authSent ? (
            <p className="text-center text-xs text-success" data-testid="sign-in-success">
