...
export type RootNodeHData = {
  label: string;
  teamIds: string[];
  teams: Record<string, TieFlowTeamMeta>;
};

const RootNodeH = ({ data }: NodeProps) => {
  const { label, teamIds, teams } = data as unknown as RootNodeHData;

  return (
    <div className="flex flex-col items-center gap-1.5 rounded-xl bg-base-200 px-3 py-2 shadow-sm">
