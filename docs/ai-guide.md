...
│   │   ├── update-games/        # Score updates (mode param: active/week/season)
│   │   ├── update-all/          # Batch endpoint (Hobby plan - calls pull-teams, update-games (mode=season), update-rankings, update-spreads)
